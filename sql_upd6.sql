...
INSERT INTO `category` VALUES (1,'co_trang_nam',1,'Cổ trang nam'),(2,'co_trang_nu',1,'Cổ trang nữ'),(3,'han_phuc_nam',1,'Hán phục nam'),(4,'han_phuc_nu',1,'Hán phục nữ'),(5,'anh_hung',1,'Anh hùng'),(6,'cong_chua',1,'Công chúa'),(7,'anime',1,'Anime'),(8,'an_do',2,'Ấn Độ'),(9,'anh',2,'Anh'),(10,'han_quoc',2,'Hàn Quốc'),(11,'nhat_ban',2,'Nhật Bản'),(12,'trung_quoc',2,'Trung Quốc'),(13,'viet_nam',2,'Việt Nam'),(24,'1_6',3,'1/6'),(25,'8_3',3,'8/3'),(26,'20_11',3,'20/11'),(27,'dong_noel',3,'Đông - noel'),(28,'gala_party',3,'Gala - party'),(29,'halloween',3,'Halloween'),(30,'he',3,'Hè'),(31,'tat_nien_tong_ket',3,'Tất niên - tổng kết'),(32,'thu_trung_thu',3,'Thu - trung thu'),(33,'xuan_tet',3,'Xuân - tết'),(34,'giay_dep_guoc',4,'Giày - dép - guốc'),(35,'kinh_kinh_ap_trong',4,'Kính - kính áp tròng'),(36,'non_mao_vuong',4,'Nón - mão - vương'),(37,'phu_kien_co_trang',4,'Phụ kiện cổ trang'),(38,'toc_gia',4,'Tóc giả'),(39,'vu_khi_dao_cu',4,'Vũ khí - đạo cụ');
...
CREATE TABLE `customer` (
  ...
  `bank_id` int DEFAULT NULL COMMENT 'Mã ngân hàng',
  `bank_code_account` varchar(255) DEFAULT NULL COMMENT 'Số tài khoản',
...
INSERT INTO `item` VALUES (1,'cosplay','cosplay'),(2,'truyen_thong','truyền thống'),(3,'mua_le_hoi','mùa - lễ hội'),(4,'phu_kien_dao_cu','phụ kiện - đạo cụ');
...
CREATE TABLE `succes_bill` (
  ...
  `status_refund` int NOT NULL COMMENT 'Trạng thái hoàn tiền (0-Thành công, 1-Chưa hoàn phía khách hàng, 2-Chưa hoàn phía cửa hàng, 3-Chưa hoàn phía cửa hàng, 4-Thất bại)',
  `bank_id` int DEFAULT NULL COMMENT 'Tên ngân hàng dùng để giao dịch',
  `bank_code` varchar(255) DEFAULT NULL COMMENT 'Tài khoản ngân hàng',
...
-- Dump completed on 2020-12-16 18:50:34
